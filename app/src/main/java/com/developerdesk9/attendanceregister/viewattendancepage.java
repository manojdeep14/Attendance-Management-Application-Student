    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attendancerecord.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String clslvt;
                if(percent>75){
                    predict.setText("Class you can bunk");
                    double pre=(tpresent-(0.75*tattencount))/0.75;
                    clslvt=String.valueOf(Math.ceil(pre));
                }
                else {
                    predict.setText("Class you need to attend");
                    double pre=((0.75*tattencount)-tpresent)/0.25;
                    clslvt=String.valueOf(Math.floor(pre));
                }
